...
draw2d.RoundCornerFigure.prototype.setContent=function(_1908){
this.textarea.innerHTML=_1908;
};
draw2d.RoundCornerFigure.prototype.onDragstart=function(x,y){
var _190b=draw2d.Node.prototype.onDragstart.call(this,x,y);
if(this.header===null){
return false;
}
...
draw2d.RoundCornerFigure.prototype.setWorkflow=function(_190d){
draw2d.Node.prototype.setWorkflow.call(this,_190d);
if(_190d!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_190d);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new draw2d.OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_190d);
