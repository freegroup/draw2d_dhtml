...
draw2d.GroupFigure.prototype.onFigureEnter=function(_291b){
if(this.children[_291b.id]===null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
draw2d.CompartmentFigure.prototype.onFigureEnter.call(this,_291b);
};
draw2d.GroupFigure.prototype.onFigureLeave=function(_291c){
draw2d.CompartmentFigure.prototype.onFigureLeave.call(this,_291c);
this.setBackgroundColor(this.defaultBackgroundColor);
};
draw2d.GroupFigure.prototype.onFigureDrop=function(_291d){
draw2d.CompartmentFigure.prototype.onFigureDrop.call(this,_291d);
this.setBackgroundColor(this.defaultBackgroundColor);
};
