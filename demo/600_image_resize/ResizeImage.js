...
draw2d.ResizeImage.prototype.setWorkflow=function(_1fae){
draw2d.Node.prototype.setWorkflow.call(this,_1fae);
if(_1fae!==null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_1fae);
...
this.outputPort2.setWorkflow(_1fae);
