...
draw2d.End.prototype.setWorkflow=function(_234b){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_234b);
if(_234b!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_234b);
