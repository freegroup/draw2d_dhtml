...
draw2d.End.prototype.setWorkflow=function(_1903){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_1903);
if(_1903!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_1903);
this.inputPort.setBackgroundColor(new draw2d.Color(115,115,245));
this.inputPort.setColor(null);
this.addPort(this.inputPort,0,this.height/2);
this.inputPort2=new draw2d.MyInputPort();
this.inputPort2.setWorkflow(_1903);
...
this.inputPort3=new draw2d.MyInputPort();
this.inputPort3.setWorkflow(_1903);
...
this.inputPort4=new draw2d.MyInputPort();
this.inputPort4.setWorkflow(_1903);
