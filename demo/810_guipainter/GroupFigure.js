...
draw2d.GroupFigure.prototype.onFigureEnter=function(_177c){
if(this.children[_177c.id]===null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
draw2d.CompartmentFigure.prototype.onFigureEnter.call(this,_177c);
};
draw2d.GroupFigure.prototype.onFigureLeave=function(_177d){
draw2d.CompartmentFigure.prototype.onFigureLeave.call(this,_177d);
this.setBackgroundColor(this.defaultBackgroundColor);
};
draw2d.GroupFigure.prototype.onFigureDrop=function(_177e){
draw2d.CompartmentFigure.prototype.onFigureDrop.call(this,_177e);
this.setBackgroundColor(this.defaultBackgroundColor);
};
