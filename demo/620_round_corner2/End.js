...
draw2d.End.prototype.setWorkflow=function(_1783){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_1783);
if(_1783!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_1783);
