...
draw2d.End.prototype.setWorkflow=function(_19de){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_19de);
if(_19de!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_19de);
