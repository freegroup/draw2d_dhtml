...
draw2d.End.prototype.setWorkflow=function(_1773){
draw2d.Node.prototype.setWorkflow.call(this,_1773);
if(_1773!==null){
this.inputPort1=new draw2d.InputPort();
this.inputPort1.setWorkflow(_1773);
...
this.inputPort2.setWorkflow(_1773);
