...
draw2d.ImageTemplates=[{"name":"Debian","file-name":"file1.iso","image-type":"cdrom","writeback":"none","readonly":"true","icon":draw2d.Configuration.IMAGEPATH+"image_debian.png"},{"name":"Gentoo","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_gentoo.png"},{"name":"My OS","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false",},{"name":"Fedora","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_fedora.png"},{"name":"Mepis","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_mepis.png"},{"name":"Red Hat","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_redhat.png"},{"name":"Suse","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_suse.png"},{"name":"Ubuntu","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_ubuntu.png"},{"name":"Xandros","file-name":"file2.iso","image-type":"fdd","writeback":"none","readonly":"false","icon":draw2d.Configuration.IMAGEPATH+"image_xandros.png"},{"name":"Music Sampler 1","file-name":"file2.iso","image-type":"cdrom","writeback":"none","readonly":"true","icon":draw2d.Configuration.IMAGEPATH+"image_mymusic.png"}];
