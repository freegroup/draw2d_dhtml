...
*/
draw2d.ToolCheckBox=function(/*:draw2d.PaletteWindow*/ palette)
{
...
draw2d.ToolCheckBox.prototype.execute=function(/*:int*/ x,/*:int*/ y)
{
  var figure= new draw2d.CheckBoxFigure();
