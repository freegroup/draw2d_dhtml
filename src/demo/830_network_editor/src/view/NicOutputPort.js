 ...
 * @type draw2d.Command 
 **/
draw2d.NicOutputPort.prototype.createCommand=function(/*:draw2d.EditPolicy*/ request)
{
   ...
   if(request.getPolicy() ==draw2d.EditPolicy.CONNECT)
   {
     ...
     if(request.source instanceof draw2d.NicInputPort)
     {
        ...
        return new draw2d.CommandConnectNic(targetModel,sourceModel);
     }
     return null;
   }
