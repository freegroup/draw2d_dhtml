...
draw2d.MountPropertyPage=function()
{
   ...
   else
   {
      Event.observe(this.orderText,"keyup",function(e)
      {
         ...
         var command = new draw2d.CommandChangeProperty(editor.getGraphicalViewer(),func,oThis.currentModel.getOrder(),oThis.orderText.value);
 ...
 *
 **/
draw2d.MountPropertyPage.prototype.init=function(/*:draw2d.AbstractObjectModel*/ model)
{
