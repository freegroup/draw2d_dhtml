...
draw2d.Start.prototype.setWorkflow=function(_2c95){
draw2d.Node.prototype.setWorkflow.call(this,_2c95);
if(_2c95!==null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_2c95);
...
this.outputPort2.setWorkflow(_2c95);
