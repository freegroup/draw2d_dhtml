...
draw2d.Start.prototype.setWorkflow=function(_2b88){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2b88);
if(_2b88!==null&&this.outputPort===null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setWorkflow(_2b88);
...
this.outputPort2.setWorkflow(_2b88);
...
this.outputPort3.setWorkflow(_2b88);
...
this.outputPort4.setWorkflow(_2b88);
