...
draw2d.Start.prototype.setWorkflow=function(_2001){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2001);
if(_2001!==null&&this.outputPort1===null){
this.outputPort1=new draw2d.OutputPort(new draw2d.ImageFigure("port1.png"));
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_2001);
...
this.outputPort2.setWorkflow(_2001);
