...
draw2d.ResizeImage.prototype.setWorkflow=function(_2339){
draw2d.Node.prototype.setWorkflow.call(this,_2339);
if(_2339!==null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_2339);
...
this.outputPort2.setWorkflow(_2339);
