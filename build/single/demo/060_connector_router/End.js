...
draw2d.End.prototype.setWorkflow=function(_2262){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2262);
if(_2262!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_2262);
...
this.inputPort2.setWorkflow(_2262);
...
this.inputPort3.setWorkflow(_2262);
...
this.inputPort4.setWorkflow(_2262);
