...
draw2d.ArrowConnection.prototype.setSource=function(port){
if(this.sourcePort!==null){
this.sourcePort.detachMoveListener(this);
}
...
draw2d.ArrowConnection.prototype.setTarget=function(port){
if(this.targetPort!==null){
this.targetPort.detachMoveListener(this);
}
...
draw2d.ArrowConnection.prototype.onOtherFigureMoved=function(_2139){
if(_2139==this.sourcePort){
