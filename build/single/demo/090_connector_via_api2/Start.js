...
draw2d.Start.prototype.setWorkflow=function(_1932){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_1932);
if(_1932!==null&&this.outputPort===null){
this.outputPort=new draw2d.OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_1932);
